...
std::string GetMSServerTestJsonPath()
{
    ...
    std::string jsonPath = GetAbsolutePath(parentPath,
        "mindie_service/management_service/test/common/.mindie_ms/ms_server.json");
    return jsonPath;
}
...
std::string GetMSClientTestJsonPath()
{
    ...
    std::string parentPath = GetParentPath(GetParentPath(GetParentPath(GetParentPath(exePath))));
    std::string jsonPath = GetAbsolutePath(parentPath,
        "mindie_service/management_service/test/common/.mindie_ms/msctl.json");
    return jsonPath;
}
...
std::string GetMSDeployTestJsonPath()
{
    ...
    std::string parentPath = GetParentPath(GetParentPath(GetParentPath(GetParentPath(exePath))));
    std::string jsonPath = GetAbsolutePath(parentPath,
        "mindie_service/management_service/test/common/.mindie_ms/infer_server.json");
    return jsonPath;
}
