...
MINDIE_MS_TEST_PATH=$PROJECT_PATH/mindie_service/management_service/test
...
pack_test_package()
{
    ...
    rm -rf $package_path
    mkdir -p $package_path/MindIE-Service/mindie_service/management_service
    cd $package_path
    cp -r  $MINDIE_MS_OUTPUT_PATH $package_path/MindIE-Service/mindie_service/management_service/
    cp -r  $PROJECT_PATH/mindie_service/management_service/ $package_path/MindIE-Service/
