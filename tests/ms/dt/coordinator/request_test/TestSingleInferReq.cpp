...
class TestSingleInferReqPrompt : public TestSingleInferReq, public ::testing::WithParamInterface<PromptParam> {
    void SetUp()
    {
        TestSingleInferReq::SetUp();
    }
};
